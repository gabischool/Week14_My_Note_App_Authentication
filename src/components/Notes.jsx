...
function Notes() {
  ...
  return (
    <div className="flex flex-wrap justify-center mt-5">
      ...
      {notes.map((note) =>  (
        <div
          className="relative bg-dark-400 w-64 h-64 m-5 shadow-2xl overflow-hidden hover:bg-white"
          key={note.id}
        >
          <div className="p-5">
          ...
          <div className="absolute bg-green-400 w-12 h-12 rotate-45 -top-6 -left-6" />
